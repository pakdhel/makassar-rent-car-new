    ...
    return (
        ...
        >
            ...
            <div className="p-4 sm:p-6 space-y-2 md:space-y-3">
                <h3 className="text-xl md:text-2xl font-bold md:font-black group-hover:text-accent transition-colors leading-tight">
                    {car.name}
                </h3>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4 py-2 sm:py-4 ">
                    <div className="flex flex-col items-center gap-1 sm:gap-2">
                        ...
                        <span className="text-base text-muted-foreground">{car.capacity}</span>
                    </div>

                    <div className="flex flex-col items-center gap-1 sm:gap-2">
                        <Clock className="w-4 h-4 md:w-5 md:h-5 text-accent" />
                        <span className="text-base text-muted-foreground">{car.transmission}</span>
                    </div>

                    {car.fuel && (
                        <div className="flex flex-col items-center gap-1 sm:gap-2">
                            <Fuel className="w-4 h-4 md:w-5 md:h-5 text-accent" />
                            <span className="text-base text-muted-foreground">{car.fuel}</span>
                        </div>
                    )}
                </div>
